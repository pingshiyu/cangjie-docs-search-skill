...
<!-- compile.error -hashset1 -->

```cangjie
var a: HashSet<Int64> = HashSet<Int64>() // HashSet whose element type is Int64
var b: HashSet<String> = HashSet<Int64>() // HashSet whose element type is String
```
